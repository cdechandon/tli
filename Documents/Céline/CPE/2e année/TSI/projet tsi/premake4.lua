...
project("projet_tsi")
        ...
        targetdir "bin"
        files ( gkit_files )
        files { gkit_dir .. "/src/projet_tsi.cpp" }
        files { gkit_dir .. "/src/mesh_buffer.cpp"}
        files { gkit_dir .. "/src/mesh_buffer.h"}
        files { gkit_dir .. "/src/mesh_data.cpp"}
        files { gkit_dir .. "/src/mesh_data.h"}
        files { gkit_dir .. "/src/material_data.cpp"}
        files { gkit_dir .. "/src/material_data.h"}
